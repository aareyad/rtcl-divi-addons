                        ...
                        <div class="rtcl-text-el-button">
                            <a class="rtcl-quick-view" href="#" title="<?php esc_attr_e( 'Quick View', 'rtcl-divi-addons' ); ?>"
                               data-listing_id="<?php echo absint( $_id ); ?>">
                                ...
                                <span><?php esc_html_e( 'Quick View', 'rtcl-divi-addons' ); ?></span>
                            </a>
                        </div>
						<?php
						$button_icon ++;
					...
					if ( 'on' === $instance['rtcl_show_compare'] ) :
                        ...
                        <div class="rtcl-text-el-button">
                            ...
                            <a class="rtcl-compare <?php echo esc_attr( $selected_class ); ?>" href="#"
                               title="<?php esc_attr_e( 'Compare', 'rtcl-divi-addons' ); ?>" data-listing_id="<?php echo absint( $_id ); ?>">
                                <i class="rtcl-icon rtcl-icon-retweet"></i>
                                <span><?php esc_html_e( 'Compare', 'rtcl-divi-addons' ); ?></span>
                            </a>
                        </div>
						<?php
						$button_icon ++;
