...
echo Functions::get_template_html( 'listing-slider/slider-header', $data, '', rtcl_divi_addons()->get_plugin_template_path() );
...
<?php
echo Functions::get_template_html( 'listing-slider/slider-footer', $data, '', rtcl_divi_addons()->get_plugin_template_path() );
