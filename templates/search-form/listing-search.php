...
$loc_text            = apply_filters( 'rtcl_divi_listing_search_location_title', esc_html__( 'Select Location', 'rtcl-divi-addons' ) );
$cat_text            = apply_filters( 'rtcl_divi_listing_search_category_title', esc_html__( 'Select Category', 'rtcl-divi-addons' ) );
$typ_text            = apply_filters( 'rtcl_divi_listing_search_ad_type_title', esc_html__( 'Select Type', 'rtcl-divi-addons' ) );
$keyword_placeholder = apply_filters( 'rtcl_divi_listing_search_keyword_title', esc_html__( 'Enter Keyword here ...', 'rtcl-divi-addons' ) );
                    ...
                    <div class="form-group">
                        <div class="rtcl-search-input-button rtcl-search-location">
                            <input type="text" name="geo_address" autocomplete="off"
                                   ...
                                   placeholder="<?php esc_html_e( "Select a location", "rtcl-divi-addons" ); ?>"
                        ...
                        <div class="form-group">
                            <div class="rtcl-search-input-button rtcl-search-radius">
                                ...
                                <input type="number" class="form-control" name="distance"
                                       ...
                                       placeholder="<?php esc_html_e( "Radius", "rtcl-divi-addons" ); ?>">
                            </div>
                        </div>
                    </div>
				<?php else: ?>
