...
$count_html = sprintf( /* translators: Ads count */ _nx( '%s Ad', '%s Ads', $count, 'Number of Ads', 'rtcl-divi-addons' ), number_format_i18n( $count ) );
    ...
    <div class="rtcl-single-location-inner">
        ...
        <div class="rtcl-location-content <?php echo esc_attr( $alignment_class ); ?>">
			...
			<?php if ( $settings['rtcl_show_count'] === 'on' ) : ?>
                <div class="rtcl-location-listing-count"><?php echo esc_html( $count_html ); ?></div>
			<?php endif; ?>
        </div>
